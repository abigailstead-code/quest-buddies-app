    ...
    rewards: [
      {
        ...
        description: "Sleep in and let the day begin gently.",
        emoji: "sunrise",
        cost: 60,
      ...
      {
        id: randomUUID(),
        title: "Favourite takeaway",
        description: "No cooking, no guilt, just the good stuff.",
        emoji: "meal",
        cost: 100,
        createdBy: room.host.id,
        active: true,
      ...
      },
      {
        ...
        description: "Protect a few hours for something just for you.",
        emoji: "pause",
        cost: 150,
        createdBy: room.host.id,
        active: true,
  ...
  const quest: Quest = {
    ...
    dueDate:
      body.dueDate instanceof Date
        ? body.dueDate.toISOString().slice(0, 10)
        : body.dueDate,
...
router.patch("/rooms/:roomId/quests/:questId", (req, res) => {
  ...
  Object.assign(quest, {
    ...
    notes: body.notes?.trim() || null,
    dueDate: body.dueDate ?? quest.dueDate,
    priority,
    coinValue: values.coins,
    xpValue: values.xp,
  });
